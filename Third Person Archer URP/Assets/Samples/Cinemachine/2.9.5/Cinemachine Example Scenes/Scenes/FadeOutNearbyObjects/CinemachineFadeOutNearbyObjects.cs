...
namespace Cinemachine.Examples
{
    ...
    public class CinemachineFadeOutNearbyObjects : CinemachineExtension
    {
        ...
        /// <summary>
        /// Minimum distanceToPlayer to have fading out effect in front of the mainCamera.
        /// </summary>
        [Tooltip("Minimum distanceToPlayer to have fading out effect in front of the mainCamera.")]
        public float m_MinDistance = 0;

        /// <summary>
        /// Maximum distanceToPlayer to have fading out effect in front of the mainCamera.
        /// </summary>
        [Tooltip("Maximum distanceToPlayer to have fading out effect in front of the mainCamera.")]
        public float m_MaxDistance = 8;

        /// <summary>
        /// If true, m_MaxDistance will be set to
        /// distanceToPlayer between this virtual mainCamera and LookAt target minus m_LookAtTargetRadius.
        /// </summary>
        [Tooltip("If true, MaxDistance will be set to " +
            "distanceToPlayer between this virtual mainCamera and LookAt target minus LookAtTargetRadius.")]
        ...
        /// </summary>
        /// <param name="vcam">The virtual mainCamera being processed</param>
        /// <param name="stage">The current pipeline stage</param>
        /// <param name="state">The current virtual mainCamera state</param>
