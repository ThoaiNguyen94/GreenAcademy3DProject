...
public class AlliesStatsSystem : MonoBehaviour
{
    ...
    public string alliesLayer;
    public string alliesType; // melee or range
    #endregion
    ...
    public void TakeDamage(int damage)
    {
        ...
        currentHealth = Mathf.Clamp(currentHealth, 0, maxHealth);
        healthBar.UpdateHealthBar(currentHealth, maxHealth);
        if (objectLayer.LayerName() != "PlayerBase")
        {
    ...
    {
        GetComponent<PlayerAudioManager>().PlayerSound("Walk");
    }

    protected void RunSound()
    {
        GetComponent<PlayerAudioManager>().PlayerSound("Run");
    }
